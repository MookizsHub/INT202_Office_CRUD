package sit.int202.classicmodel.repositories;
...
public class OfficeRepository {
    ...
    public boolean update(Office newOffice) { // get new office and update with the ref.
        if (newOffice != null) {
            EntityManager entityManager = getEntityManager();
            Office office = find(newOffice.getOfficeCode()); // find it
            if (office != null) {
                entityManager.getTransaction().begin();
                ...
                entityManager.getTransaction().commit(); //set all save
                return true;
            }
        }
