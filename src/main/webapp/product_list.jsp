    ...
    <c:forEach items="${products}" var="p" varStatus="vs">
        <div class="col-2 my-1 mx-3">
            <div class="img-fluid img-thumbnail" title="${p.productCode}">
                <img src="./model-images/${p.productLine}/${p.productCode}.jpg" height="120" width="180" alt="`${p.productName}`"/>
            </div>
...
<div class="d-flex flex-row">
    ...
    <div class="px-4 mx-1">
        items per page:
        <label for="itemsPage"></label><select id="itemsPage" onchange="loadProduct(1)">
